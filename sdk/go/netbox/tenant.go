...
func NewTenant(ctx *pulumi.Context,
	...
	var resource Tenant
	err := ctx.RegisterResource("netbox:index/tenant:Tenant", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTenant(ctx *pulumi.Context,
	...
	var resource Tenant
	err := ctx.ReadResource("netbox:index/tenant:Tenant", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
