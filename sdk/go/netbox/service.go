...
func NewService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbox:index/service:Service", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetService(ctx *pulumi.Context,
	...
	var resource Service
	err := ctx.ReadResource("netbox:index/service:Service", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
