...
export class Provider extends pulumi.ProviderResource {
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["apiToken"] = (args ? args.apiToken : undefined) ?? utilities.getEnv("NETBOX_API_TOKEN");
            resourceInputs["headers"] = pulumi.output(args ? args.headers : undefined).apply(JSON.stringify);
            resourceInputs["serverUrl"] = (args ? args.serverUrl : undefined) ?? utilities.getEnv("NETBOX_SERVER_URL");
