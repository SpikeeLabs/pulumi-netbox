...
export class DeviceRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'netbox:index/deviceRole:DeviceRole';
    ...
    public readonly vmRole!: pulumi.Output<boolean | undefined>;
    ...
    constructor(name: string, argsOrState?: DeviceRoleArgs | DeviceRoleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["vmRole"] = state ? state.vmRole : undefined;
        } else {
            ...
            resourceInputs["vmRole"] = args ? args.vmRole : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(DeviceRole.__pulumiType, name, resourceInputs, opts);
    }
}
