...
export class Region extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'netbox:index/region:Region';
    ...
    public readonly parentRegionId!: pulumi.Output<number | undefined>;
...
export interface RegionState {
    ...
    parentRegionId?: pulumi.Input<number>;
