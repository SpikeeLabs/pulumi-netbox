...
namespace HBJYDev.Netbox
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("HBJYDev.Netbox.version.txt");
    ...
    internal sealed class NetboxResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NetboxResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
